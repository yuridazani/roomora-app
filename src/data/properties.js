export const properties = [
    { 
        ...
        reviews: [
            { user: "Jane Doe", rating: 5, comment: "Absolutely breathtaking! The view is incredible and the service was top-notch." }
        ]
    },
    { 
        id: 2, 
        ...
        reviews: [
            { user: "Ahmad Subarjo", rating: 4.5, comment: "Hotelnya megah, kamarnya luas dan bersih." }
        ]
    },
    { 
        id: 3, 
        ...
        reviews: [
            { user: "Lina Hartati", rating: 5, comment: "Best resort ever! Sunset by the beach is magical." }
        ]
    },
    { 
        id: 4, 
        name: "Rumah Mertua Boutique Guesthouse", 
        category: "Guesthouse", 
        price: 450000, 
        rating: 4.6, 
        location: "Jogja", 
    ...
    { 
        ...
        reviews: [
            { user: "Stephanie", rating: 5, comment: "Truly paradise. Every detail is perfect." }
        ]
    },
    { 
        id: 6, 
        ...
        reviews: [
            { user: "Rizky Ananda", rating: 4.8, comment: "Pemandangan hijau dari balkon luar biasa. Sarapan enak banget." }
        ]
    },
    { 
        id: 7, 
        name: "The Phoenix Heritage Hotel", 
        category: "Hotel", 
        price: 1600000, 
        rating: 4.6, 
        location: "Jogja", 
        ...
        reviews: [
            { user: "Maria", rating: 4.7, comment: "Suasana klasiknya bikin pengalaman menginap beda." }
        ]
    },
    { 
        id: 8, 
        name: "Amarterra Villas Nusa Dua", 
        category: "Villa", 
        price: 3800000, 
        rating: 4.9, 
        location: "Bali", 
        ...
        reviews: [
            { user: "Kevin", rating: 5, comment: "Private, romantic, dan sangat tenang. Cocok untuk honeymoon." }
        ]
    },
    { 
        id: 9, 
        name: "Senggigi Sunset Resort", 
        category: "Resort", 
        price: 2800000, 
        rating: 4.7, 
        location: "Lombok", 
        ...
        reviews: [
            { user: "Putri", rating: 4.6, comment: "Sunsetnya luar biasa, suasana resort tenang." }
        ]
    },
    { 
        id: 10, 
        name: "Hyatt Regency Jogja", 
        category: "Hotel", 
        price: 1400000, 
        rating: 4.6, 
        location: "Jogja", 
        ...
        reviews: [
            { user: "Yanti", rating: 4.5, comment: "Fasilitas lengkap, ada golf course, cocok buat liburan keluarga." }
        ]
    }
];